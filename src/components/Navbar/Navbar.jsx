        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between p-5">
          ...
          <div className={`${isOpen ? "block" : "hidden"} w-full md:flex md:items-center md:w-auto`} id="navbarSupportedContent">
            ...
            {UserLogin !== null ? <>
              ...
              {UserLogin === null ? <>
                <NavLink to='Login'>
                <button className="nav-link text-uppercase" data-category="Login">
                Login
                </button>
              </NavLink>
              <NavLink to='Register'>
                <button className="nav-link text-uppercase " data-category="Register">
                  Register
                </button>
              </NavLink>
              </>:<button onClick={logOut} className='nav-link text-uppercase text-md mx-4 bg-red-950 hover:border-red-600 dark:text-gray-100 text-slate-700 font-normal cursor-pointer'>
