...
export default function Register() {
  ...
  let validationSchema = yup.object().shape({
    ...
    password: yup.string().matches(/^[A-Z][a-z0-9]{5,10}$/, 'Input must start with a capital letter and have 5–10 lowercase letters or numbers').required('Input must start with a capital letter and have 5–10 lowercase letters or numbers.'),
  ...
  return <>
    <div className="max-w-lg mx-auto rounded-lg border shadow-md px-8 py-10 flex flex-col items-center">
      ...
      <h1 className='text-center text-white'>Register Now<i class="fa-solid fa-address-card ml-2 text-red-900"></i></h1>
